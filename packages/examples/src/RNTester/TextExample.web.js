    ...
    return (
      <View>
        ...
        <Text adjustsFontSizeToFit={true} numberOfLines={1} style={{ marginVertical: 6 }}>
          ...
          <Text style={{ fontSize: 20 }}>{'LARGE TEXT! ' + this.state.dynamicText}</Text>
        </Text>
...
exports.examples = [
  ...
  },
  {
    ...
    render: function() {
      return (
        <Text style={{ padding: 10 }}>This text is indented by 10px padding on all sides.</Text>
      );
    }
  },
  {
    ...
    render: function() {
      return (
        <View>
          <Text style={{ fontFamily: Platform.isTVOS ? 'Times' : 'Cochin' }}>Cochin</Text>
          <Text
            style={{
          ...
          <Text style={{ fontFamily: Platform.isTVOS ? 'Courier' : 'Verdana' }}>Verdana</Text>
          <Text
            style={{
  ...
  },
  {
    ...
    render: function() {
      return (
        <View>
          <Text selectable={true}>
            This text is <Text style={{ fontWeight: 'bold' }}>selectable</Text> if you
            click-and-hold.
          </Text>
        </View>
      );
    ...
    render: function() {
      return (
        <View>
          ...
          <Text style={{ textAlign: 'justify' }}>
            justify: this text component{"'"}s contents are laid out with "textAlign: justify" and
            as you can see all of the lines except the last one span the available width of the
            parent container.
          </Text>
        </View>
      );
      ...
      return (
        <View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <Text
              style={{ fontSize: 12, letterSpacing: 2, backgroundColor: 'fuchsia', marginTop: 5 }}
            >
          ...
          <Text style={{ backgroundColor: '#ffaaaa' }}>
            ...
            <Text style={{ backgroundColor: '#aaaaff' }}>
              ...
              <Text>
                ...
                <Text style={{ backgroundColor: '#aaffaa' }}> nested green background.</Text>
              </Text>
            </Text>
          </Text>
        </Text>
      ...
      return (
        <View>
          <Text numberOfLines={1}>
            Maximum of one line, no matter how much I write here. If I keep writing, it{"'"}ll just
            truncate after one line.
          </Text>
          <Text numberOfLines={2} style={{ marginTop: 20 }}>
            Maximum of two lines, no matter how much I write here. If I keep writing, it{"'"}ll just
            truncate after two lines.
          </Text>
          <Text style={{ marginTop: 20 }}>
            No maximum lines specified, no matter how much I write here. If I keep writing, it{"'"}ll
  ...
  },
  {
    ...
    render: function() {
      return (
        <View>
          <Text>
            By default, text will respect Text Size accessibility setting on iOS. It means that all
            font sizes will be increased or descreased depending on the value of Text Size setting
            in{' '}
            <Text style={{ fontWeight: 'bold' }}>
