...
import infoLog from '../../modules/infoLog';
...
class VirtualizedList extends React.PureComponent<Props, State> {
  ...
  getScrollableNode() {
    if (this._scrollRef && this._scrollRef.getScrollableNode) {
      ...
      console.log('Whoops! NOT a Scroll View');
      return undefined;
    ...
    for (let ii = first; ii <= last; ii++) {
      ...
      cells.push(
        <CellRenderer
          ...
          key={key}
          onLayout={e => this._onCellLayout(e, key, ii)} // eslint-disable-line react/jsx-no-bind
...
> {
  ...
  render() {
    ...
    return (
      <CellRendererComponent {...this.props} onLayout={onLayout} style={cellStyle}>
        {element}
        {itemSeparator}
      </CellRendererComponent>
    );
