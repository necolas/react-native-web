...
class Slider extends PureComponent {
  ...
  render() {
    ...
    return (
      <View {...other} onLayout={this._measureContainer} style={[defaultStyles.container, style]}>
        ...
        />
        <Animated.View
          style={[defaultStyles.track, minimumTrackStyle]} />
        <Animated.View
  ...
  _getThumbTouchRect = () => {
    ...
    return new Rect(
      touchOverflowSize.width / 2 + this._getThumbLeft(this._getCurrentValue()) + (state.thumbSize.width - THUMB_TOUCH_SIZE) / 2,
